...
- **记忆提取** — 扫描 Claude Code / Codex CLI 的本地对话日志，可用廉价的 LLM 提炼结构化记忆
- **一键注入** — 安装 Skill 后，在任意项目目录说 `/al-pull` 即可将记忆写入 CLAUDE.md / AGENTS.md，或UI界面项目中点击注入更便捷
- **记忆搜索** — `/al-search` 可搜索记忆（完善中）
